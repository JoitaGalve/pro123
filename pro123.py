...
xtrain, xtest, ytrain, ytest = train_test_split(X, y, random_state = 9, train_size = 500, test_size = 2500)
...
while(True):
    try:
        ...
        cv2.rectangle(gray, upperleft, bottom_right, (0, 255, 0), 2)

    #To only consider the area inside the box for detecting the digit
    #roi = Region Of Interest
    roi = gray[upperleft[1]:bottom_right[1], upperleft[0]:bottom_right[0]]
